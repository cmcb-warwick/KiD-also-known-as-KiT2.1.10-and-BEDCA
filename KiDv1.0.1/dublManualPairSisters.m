...
%
%    chanOrder: {[2 1 3]} or other subset of [1,2,3]. Specify RGB order for 
%		    visualisation. 
%
%    coordChans: {[1 2]} or any subset of [1,2,3]. The channels for which
%                   sisterList structures will be produced. 
%
%    imageChans: {1} or any subset of [1,2,3]. The channels which will
...
% Modified by J. U. Harrison
% Copyright (c) 2021 J. U. Harrison

% default options
opts.chanOrder = [2 1 3]; % order of the channels in the movie
opts.coordChans = [1 2]; %passed to pairSpots
